A standalone GUI utility to unzip zip archives found in a user-provided folder.  The tool will iterate through the directory structure to find zip files and nested zip files.
